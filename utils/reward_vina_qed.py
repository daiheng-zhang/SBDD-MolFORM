...
def reward_from_generated(
    ...
    """
    Compute mixed reward with normalized Vina + normalized QED:
        r(m) = (-clip(vina(m), -16, -1) + 1) / 15 + (QED(m) - 0.17) / 0.83
    """
